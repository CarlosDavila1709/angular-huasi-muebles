...
@Component({
  selector: 'app-reporteplanilla',
  templateUrl: './reporteplanilla.component.html',
  styles: [
  ]
})
...
export class ReporteplanillaComponent implements OnInit, OnDestroy {
  ...
  constructor( private fb: FormBuilder, public planillaEmpleadoService: PlanillaEmpleadoService, public modalMostrarProyectosService: ModalMostrarProyectosService){}
  ...
  mostrarModalProyectosTrabajador(){
    this.modalMostrarProyectosService.abrirModal();
  }
}
